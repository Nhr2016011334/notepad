...
public class MainActivity extends Activity {
    ...
    private void InsertDialog(){
        ...
        new AlertDialog.Builder(this).setTitle("新建笔记").setView(tableLayout)
    ...
    private void DeleteDialog(final String strId){
        new AlertDialog.Builder(this).setTitle("删除笔记").setMessage("是否真的删除？")
    ...
    private void UpdateDialog(final String strId,final String strTitle,final String strContext,final String strTime){
        ...
        new AlertDialog.Builder(this).setTitle("修改笔记").setView(tableLayout)
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void SearchDialog(){
        ...
        new AlertDialog.Builder(this).setTitle("查找").setView(tableLayout)
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
